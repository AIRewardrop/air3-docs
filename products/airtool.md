...
AIRTool is the community deployment / rental layer for the AIR3 text agent.

## Default availability

The AIR3 text agent is available by default only in the official AIR3 Discord and Telegram communities.

## Third-party community access

Projects can rent the AIR3 agent for their own Discord and/or Telegram communities through a buy + burn combo that unlocks the AIR3 agent feature set.

This allows projects to bring AIR3-style intelligence into their own communities without building the full infrastructure stack.
