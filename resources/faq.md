...
The vault must reduce the same percentage of all positions (pro-rata). This can create a large deleveraging event and introduces slippage/execution/margin risks.
