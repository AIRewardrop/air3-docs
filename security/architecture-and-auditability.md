...
_AIRTrack dashboard view used for strategy tracking, simulation visibility, and performance review._

### 2) Social trade traceability

AIR3 publishes trade-related updates on X through the official AIRRewardrop account:

* [https://x.com/AIRewardrop](https://x.com/AIRewardrop)
...
![X Trade Traceability Example](../.gitbook/assets/x-trade-traceability-example.png) _Figure: Example X post flow showing social trade traceability with entry announcement and closing confirmation card including realized PnL._

_Example social trade traceability flow with closing confirmation card and realized PnL._
